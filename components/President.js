  ...
  return (
    ...
    <section className="bg-white dark:bg-gray-900 ">
        ...
        <div class="flex flex-col">
          <div class="mt-4 grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-6 px-18">
            <div class="flex items-start rounded-xl bg-white p-4 shadow-lg">
              ...
              <div class="ml-4">
                <h2 class="font-semibold">환율(USD)</h2>
                <p class="mt-2 text-sm text-gray-500">{economyIndicators.exchange} 원/달러</p>
              </div>
            ...
            <div class="flex items-start rounded-xl bg-white p-4 shadow-lg">
              ...
              <div class="ml-4">
                <h2 class="font-semibold">코스피</h2>
                <p class="mt-2 text-sm text-gray-500">{economyIndicators.kospi}</p>
              </div>
            ...
            <div class="flex items-start rounded-xl bg-white p-4 shadow-lg">
              ...
              <div class="ml-4">
                <h2 class="font-semibold">코스닥</h2>
                <p class="mt-2 text-sm text-gray-500">{economyIndicators.kosdaq}</p>
              </div>
            ...
            <div class="flex items-start rounded-xl bg-white p-4 shadow-lg">
              ...
              <div class="ml-4">
                <h2 class="font-semibold">유가(두바이)</h2>
                <p class="mt-2 text-sm text-gray-500">{economyIndicators.oil} 달러/배럴</p>
              </div>
            </div>
            <div class="flex items-start rounded-xl bg-white p-4 shadow-lg">
              ...
              <div class="ml-4">
                <h2 class="font-semibold">금 시세</h2>
                <p class="mt-2 text-sm text-gray-500">{economyIndicators.gold} 달러/t oz</p>
              </div>
            </div>
            <div class="flex items-start rounded-xl bg-white p-4 shadow-lg">
              ...
              <div class="ml-4">
                <h2 class="font-semibold">CD금리(91일)</h2>
                <p class="mt-2 text-sm text-gray-500">{economyIndicators.cdinterest} %/년</p>
              </div>
            </div>
          </div>
        </div>
